...
function MyProgress(props) {
  return (
    <div className="firstcss">
      <h2>Tiny Wins Propel You Forward!</h2>
      <br /> <h2>Hello from {props.name} </h2>{" "}
      <strong>
        {" "}
        <a href="https://twitter.com/MohsinRaz_">
          {" "}
          <h2> </h2>
        </a>{" "}
      </strong>
      ...
      <center>
        <ul className="boom">
          ...
          <tr>Async function/Await</tr>
          <tr>useEffect Hook</tr>
          <tr>Material-UI</tr>
        </ul>
      </center>
      <br />
      <h4>
        {" "}
        Our Goal is to become a fullstack Webdeveloper to provide end to end
        solutions.{" "}
      </h4>
      <h3>
        Clock is ticking! {2 + 1} {1 + 1} {1}!
      </h3>
      <p>UPDATE: 20-06-2020</p>
      <p>UPDATE: 06-07-2020</p>
    </div>
  );
}
